...
TEXT="Job Name: $CI_JOB_NAME%0AStatus: $CI_JOB_STATUS%0A%0APipeline:$CI_PIPELINE_IID%0AProject:+$CI_PROJECT_NAME%0AURL:+$CI_PROJECT_URL/pipelines/$CI_PIPELINE_ID/%0ABranch:+$CI_COMMIT_REF_SLUG%0AMessage for Misha:$CI_COMMIT_MESSAGE"
